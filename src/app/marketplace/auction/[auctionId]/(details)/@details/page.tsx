			...
			<Stack className={`${classes.permits} ${classes.section}`}>
				...
				<Group className={classes.row}>
					<Stack className={classes.cell}>
						...
						<Group className={classes.row}>
							<Text className={classes.value}>
								{format.number(Math.round((available / 100) * auctionData.permits))}
							</Text>
					...
					<Stack className={classes.cell}>
						...
						<Group className={classes.row}>
							<Text className={classes.value}>
								{format.number(Math.round((bought / 100) * auctionData.permits))}
							</Text>
							<Text className={classes.unit}>permits</Text>
						</Group>
					</Stack>
			...
			<Stack className={`${classes.winnings} ${classes.section}`}>
				...
				<Group className={classes.row}>
					<Stack className={classes.cell}>
						...
						<Group className={classes.row}>
							<Text className={classes.value}>
								{format.number(Math.round(myOpenAuctionResults.permitsReserved))}
							</Text>
							<Text className={classes.unit}>permits</Text>
						</Group>
					</Stack>
					...
					<Stack className={classes.cell}>
						...
						<Group className={classes.row}>
							<CurrencyBadge />
							<Text className={classes.value}>
								{format.number(Math.round(myOpenAuctionResults.finalBill), 'money')}
							</Text>
						</Group>
					</Stack>
				</Group>
