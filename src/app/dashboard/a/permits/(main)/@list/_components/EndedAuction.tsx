...
import { IconRefresh, IconUser, IconCalendar, IconCheck, IconDots, IconX } from "@tabler/icons-react"
        ...
        <Flex flex={1} align={"center"} justify={"space-between"} className={classes.left}>
          <Stack gap={0} className={classes.text}>
            <Id
              ...
              variant="auction"
            />
            <Title order={2} className={classes.name}>{props.name}</Title>
          ...
          <Group className={classes.chart}>
            <Text className={classes.chartText}>{t("dashboard.permits.endedAuctions.chart")}</Text>
            <PieChart
              data={[
                    ...
                    >
                      <Group gap={8} wrap="nowrap">
                        ...
                        <Text size="sm" c="gray.7">
                          {t("dashboard.permits.endedAuctions.tooltip", {
                            status: data.name,
                            value: data.value,
                          })}
                        </Text>
