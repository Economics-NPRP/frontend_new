...
export interface IGetPaginatedBidsOptions extends IOffsetPagination {
	auctionId: string;
}
...
export const getPaginatedBids: IFunctionSignature = cache(async ({ auctionId, page, perPage }) => {
